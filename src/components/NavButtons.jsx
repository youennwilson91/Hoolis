...
export default function Button({ screenRef, labelRef, buttonsPosition }) {
    ...
    const buttons = [
        ...
        {id: 5, landingPosition: {transform: 'translate(-230px, -40px)'}, menuPosition: {transform: 'translate(-250px, 45vh)'}, label: "CONTACT", bgColor: "#226D68", labelColor: "#21514e", upscale: 1.6, navigate: "/contact"},
    ]
